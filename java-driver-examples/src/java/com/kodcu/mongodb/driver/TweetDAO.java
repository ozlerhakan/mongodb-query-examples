...
interface TweetDAO {
     ...
     */
    Document findTweetBy(String id);
     ...
     *
     * @param followersCount for example: type 100000 which points the number of followers for the lower bound
     * @return AggregationResults which contains the list of {@link Document}
     */
    List<Document> findUsersByFollowersGreaterThan(int followersCount);
